 ...
 * @author Lenovo
 */
@WebServlet(name="OrderDetailsAdminServlet", urlPatterns={"/admin/order/order_details"})
public class OrderDetailsServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/view/admin/order/details_order.jsp").forward(request, response);
    } 
