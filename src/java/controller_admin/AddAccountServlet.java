 ...
 * @author Lenovo
 */
@WebServlet(name="AddAccountServlet", urlPatterns={"/admin/account/add"})
...
public class AddAccountServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("/view/admin/account/add_account.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        String uploadPath = getServletContext().getRealPath("") + "/assets/images" + File.separator + "uploads/avatar";
        File uploadDir = new File(uploadPath);
        if (!uploadDir.exists()) {
            uploadDir.mkdir();
        }
        
        String fileName = "avatar_" + System.currentTimeMillis() + "_" + Paths.get(imagePart.getSubmittedFileName()).getFileName().toString();
