...
public class PaymentVNPayServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String vnp_TxnRef = String.format("%08d", random.nextInt(100000000));
...
//        int amount = Integer.parseInt(req.getParameter("amount")) * 100;
        ...
        String vnp_ReturnUrl = "http://localhost:8080/Ecommer_Website/thanks"; // Thay URL thực tế của bạn
        ...
        String vnp_PayUrl = "https://sandbox.vnpayment.vn/paymentv2";
