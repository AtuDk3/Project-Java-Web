...
public class RegisterServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (service.checkExitsUserName(userName)){
        ...
        if (service.checkExitsPhone(phone)){
            alertMsg = "Phone already exists!";
            request.setAttribute("alert", alertMsg);
            request.setAttribute("uName", userName);
            request.setAttribute("uEmail", email);
            request.setAttribute("uPass", password);
        ...
        boolean isSuccess = service.register(userName, email, password, phone);
        if (isSuccess){
