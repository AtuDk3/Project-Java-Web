 ...
 * @author Lenovo
 */
@WebServlet(name="HotProductServlet", urlPatterns={"/product/hot_product"})
   ...
   ProductService productService = new ProductServiceImpl();
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HotProductServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HotProductServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
       ...
       List<Product> listHotProducts = productService.getHotProduct();
        request.setAttribute("listHotProducts", listHotProducts);
        
        request.getRequestDispatcher("/view/hot_products.jsp").forward(request, response);
    } 
