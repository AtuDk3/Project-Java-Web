 ...
 * @author Lenovo
 */
@WebServlet(name="CartAddServlet", urlPatterns={"/member/cart_add"})
public class CartAddServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        cartItem.setQuantity(quantityProduct);
        cartItem.setUnitPrice(product.getPriceProduct());
        ...
        if (obj == null){
            ...
            map.put(cartItem.getProduct().getIdProduct(), cartItem);
            session.setAttribute("cart", map);
        }
        else {
            Map<Integer, CartItem> map = extracted(obj);
            CartItem exitsCartItem = map.get(idProduct);
            
            if (exitsCartItem == null){
                map.put(product.getIdProduct(), cartItem);
            }
            else {
                exitsCartItem.setQuantity(exitsCartItem.getQuantity() + quantityProduct);
            }
            session.setAttribute("cart", map);
        }
