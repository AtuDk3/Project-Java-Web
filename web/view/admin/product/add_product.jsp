                ...
                <div class="container-form-add-product">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/product/add" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter name product" name="titleProduct" required>
                        </div>
                        <div class="form-group">
                            <label for="nameCategory">Image Product</label>
                            <input type="file" class="form-control" name="imageProduct" required>
                        </div>
                        <div class="row g-2">
                            <div class="col">
                                <label for="describeCategory">Price Product</label>
                                <input type="text" class="form-control" placeholder="Enter price product " name="priceProduct" required>
                            </div>
                            <div class="col">
                                <label for="describeCategory">Number of products</label>
                                <input type="text" class="form-control" placeholder="Enter the number of products" name="quantityProduct" required>
                            </div>            
                        </div>
                        <div class="row g-2">
                            <div class="col">
                                <label>Hot Product :</label>
                                <select name="hotProduct" required>                   
                            ...
                            <div class="col">
                                ...
                                <select name="idCategoryProduct" required>
                                    <c:forEach items="${requestScope.categoryProduct}" var="categoryProduct" >
                                    <option class="option" value="${categoryProduct.idCategoryProduct}">
                                        ${categoryProduct.titleCategoryProduct}
                                    </option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea type="text" id="editor1" class="form-control" placeholder="Enter describe product here ..." name="descProduct"
                                          required></textarea>
                            </div>
